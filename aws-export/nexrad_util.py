...
# time zones were computed using package timezonefinder
...
#     "KJAN": {'lat': 32.3205, 'lon': -90.0777, 'elev': 330},
...
#     locations_file.write('NEXRAD_LOCATIONS = {\n')
#     tf = TimezoneFinder()
#     for station in NEXRAD_LOCATIONS.keys():
#         NEXRAD_LOCATIONS[station]['tz'] = tf.timezone_at(lng=NEXRAD_LOCATIONS[station]['lon'], lat=NEXRAD_LOCATIONS[station]['lat'])
#         locations_file.write('    \"{}\": {{\'lat\': {: <10} \'lon\': {: <12} \'elev\': {: <7} \'tz\': \'{}\'}},\n'.format(station, str(NEXRAD_LOCATIONS[station]['lat']) + ',', str(NEXRAD_LOCATIONS[station]['lon']) + ',', str(NEXRAD_LOCATIONS[station]['elev']) + ',', NEXRAD_LOCATIONS[station]['tz']))
...
# for station in NEXRAD_LOCATIONS.keys():
#     if NEXRAD_LOCATIONS[station]['lat'] != NEXRAD_LOCATIONS2[station]['lat'] or NEXRAD_LOCATIONS[station]['lon'] != NEXRAD_LOCATIONS2[station]['lon'] or NEXRAD_LOCATIONS[station]['elev'] != NEXRAD_LOCATIONS2[station]['elev']:
#         print('error')
