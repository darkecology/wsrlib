...
for i=1:nbins
    ...
    %   2. Trim values > 35 dBZ
    %   3. Average remaining Z values
    ...
    % "MEDIAN" Z
    %   1. Trim values > 35 dBZ
    %   2. Compute median a of nonzero Z values
    %   3. Approximate average as
    %       
    %      n1 * a / n
    %     
